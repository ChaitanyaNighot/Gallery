...
public class Sports_data {
    ...
    public static List<Sports_list> getListData() {
        List<Sports_list> data = new ArrayList<>();
        ...
        for (int i = 0; i < titles.length; i++) {
            Sports_list item = new Sports_list(icon[i],subTitles[i],titles[i],month[i],date[i],day[i],fee[i],address[i],totaldate[i],
