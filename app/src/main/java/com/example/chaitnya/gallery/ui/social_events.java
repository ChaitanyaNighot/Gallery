...
import com.example.chaitnya.gallery.adapter.socialEventAdapter;

import java.util.ArrayList;

public class social_events  extends AppCompatActivity implements socialEventAdapter.ItemClickCallback{
    ...
    private socialEventAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new socialEventAdapter(social_events_data.getListData(), this);
