...
public class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.DerpHolder>{

    private List<Sports_list> listData;
    ...
    public SportsAdapter(List<Sports_list> listData, Context mcontext){
    ...
    @Override
    public SportsAdapter.DerpHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(DerpHolder holder, int position) {
        ...
        Sports_list item = listData.get(position);
    ...
    public void setListData(ArrayList<Sports_list> exerciseList) {
        this.listData.clear();
