...
public class Camp_data  {
    ...
    public static List<Camp_list> getListData() {
        List<Camp_list> data = new ArrayList<>();
        ...
        for (int i = 0; i < titles.length; i++) {
            Camp_list item = new Camp_list(icon[i],subTitles[i],titles[i],month[i],date[i],day[i],fee[i],address[i],totaldate[i],
