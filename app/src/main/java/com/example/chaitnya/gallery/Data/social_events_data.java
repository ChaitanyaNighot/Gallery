...
public class social_events_data {
    ...
    public static List<Social_event_list> getListData() {
        List<Social_event_list> data = new ArrayList<>();
        ...
        for (int i = 0; i < titles.length; i++) {
            Social_event_list item = new Social_event_list(icon[i],subTitles[i],titles[i],month[i],date[i],day[i],fee[i],address[i],totaldate[i],
