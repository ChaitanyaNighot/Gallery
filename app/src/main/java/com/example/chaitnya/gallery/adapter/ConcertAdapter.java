...
public class ConcertAdapter extends RecyclerView.Adapter<ConcertAdapter.DerpHolder>{

private List<Concerts_list> listData;
...
public interface ItemClickCallback {
    ...
    public ConcertAdapter(List<Concerts_list> listData, Context mcontext){
    ...
    @Override
    public ConcertAdapter.DerpHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(DerpHolder holder, int position) {
        ...
        Concerts_list item = listData.get(position);
    ...
    public void setListData(ArrayList<Concerts_list> exerciseList) {
        this.listData.clear();
