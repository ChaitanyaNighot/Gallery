...
import com.example.chaitnya.gallery.adapter.ConcertAdapter;
import com.example.chaitnya.gallery.adapter.SportsAdapter;
import com.example.chaitnya.gallery.cutomer_info;

import java.util.ArrayList;

public class concerts extends AppCompatActivity implements ConcertAdapter.ItemClickCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ConcertAdapter(Concert_data.getListData(), this);
    ...
    public void onItemClick(int p) {
        ...
        Concerts_list item = (Concerts_list) listData.get(p);

        Intent i = new Intent(this,Concerts_details.class);
