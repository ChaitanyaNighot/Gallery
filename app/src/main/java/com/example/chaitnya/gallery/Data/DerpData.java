...
import com.example.chaitnya.gallery.ui.ListItem;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by CHAITNYA on 12/11/2016.
 */
    ...
    public static List<ListItem> getListData() {
        ...
        //RecyclerView
            ...
            for (int i = 0; i < titles.length; i++) {
                ListItem item = new ListItem(icon[i],subTitles[i],titles[i],month[i],date[i],day[i],fee[i],address[i],totaldate[i],
