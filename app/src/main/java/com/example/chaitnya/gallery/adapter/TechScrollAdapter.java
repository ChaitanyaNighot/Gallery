...
public class TechScrollAdapter extends PagerAdapter {
    ...
    public TechScrollAdapter(Context ctx)
    {
        this.ctx=ctx;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View item_view = layoutInflater.inflate(R.layout.techscroll,container,false);
        ImageView imageView =(ImageView)item_view.findViewById(R.id.techscroll_img_view);
