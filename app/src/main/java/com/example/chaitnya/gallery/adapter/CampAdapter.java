...
public class CampAdapter extends RecyclerView.Adapter<CampAdapter.DerpHolder>{

    private List<Camp_list> listData;
    ...
    public CampAdapter(List<Camp_list> listData, Context mcontext){
    ...
    @Override
    public CampAdapter.DerpHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(DerpHolder holder, int position) {
        ...
        Camp_list item = listData.get(position);
    ...
    public void setListData(ArrayList<Camp_list> exerciseList) {
        this.listData.clear();
